## turtlebot3 (kilted) - 2.3.6-1

The packages in the `turtlebot3` repository were released into the `kilted` distro by running `/usr/bin/bloom-release turtlebot3 -t kilted -r kilted --edit` on `Mon, 15 Dec 2025 23:54:40 -0000`
...
## turtlebot3 (jazzy) - 2.3.6-1

The packages in the `turtlebot3` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release turtlebot3 -t jazzy -r jazzy --edit` on `Mon, 15 Dec 2025 23:23:16 -0000`
...
## turtlebot3 (humble) - 2.3.6-1

The packages in the `turtlebot3` repository were released into the `humble` distro by running `/usr/bin/bloom-release turtlebot3 -t humble -r humble --edit` on `Mon, 15 Dec 2025 23:05:57 -0000`
...
## turtlebot3 (kilted) - 2.3.4-1

The packages in the `turtlebot3` repository were released into the `kilted` distro by running `/usr/bin/bloom-release turtlebot3 -t kilted -r kilted --edit` on `Tue, 18 Nov 2025 06:54:31 -0000`
...
## turtlebot3 (jazzy) - 2.3.3-1

The packages in the `turtlebot3` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release turtlebot3 -t jazzy -r jazzy --edit` on `Mon, 14 Jul 2025 07:00:57 -0000`
...
## turtlebot3 (humble) - 2.3.3-1

The packages in the `turtlebot3` repository were released into the `humble` distro by running `/usr/bin/bloom-release turtlebot3 -t humble -r humble --edit` on `Mon, 14 Jul 2025 06:49:57 -0000`
...
## turtlebot3 (jazzy) - 2.3.2-1

The packages in the `turtlebot3` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release turtlebot3 -t jazzy -r jazzy --edit` on `Tue, 08 Jul 2025 01:27:14 -0000`
...
## turtlebot3 (humble) - 2.3.2-1

The packages in the `turtlebot3` repository were released into the `humble` distro by running `/usr/bin/bloom-release turtlebot3 -t humble -r humble --edit` on `Tue, 08 Jul 2025 01:10:23 -0000`
...
The packages in the `turtlebot3` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release turtlebot3 -t jazzy -r jazzy --edit` on `Fri, 30 May 2025 10:03:14 -0000`
